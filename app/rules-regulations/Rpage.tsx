  ...
  const cards = [
    {
      ...
      desc:
        "Your legal right to enter, stay, and return. Understand what your visa truly allows — and how small violations quietly affect future travel.",
      slug: "immigration-visa",
    },
    {
      title: "Work & Employment Permissions",
      desc:
        "What you’re allowed to earn, and under what conditions. Covers work permissions, hour limits, freelance rules, and risks of unauthorized work.",
      slug: "work-employment",
    },
    {
      title: "Residence, Registration & ID Laws",
      desc:
        "What you must register, report, or carry — and when. Explains address registration, ID rules, renewals, and common documentation gaps.",
      slug: "residence-registration-id",
    },
    {
      title: "Housing, Rental & Tenant Laws",
      desc:
        "Where you can live, how you can rent, and what protects you. Covers rental contracts, deposits, subletting, and tenant rights.",
      slug: "housing-rental-tenant",
    },
    {
      title: "Financial, Tax & Banking Compliance",
      desc:
        "How money is tracked, taxed, and regulated. Understand tax residency, banking rules, reporting duties, and common financial mistakes.",
      slug: "financial-tax-banking",
    },
    {
      title: "Healthcare, Insurance & Legal Obligations",
      desc:
        "What you’re required to have before you need it. Covers insurance requirements, healthcare access, and medical legal responsibilities.",
      slug: "healthcare-insurance-legal",
    },
    {
      title: "Public Conduct, Civil & Local Laws",
      desc:
        "Everyday rules that differ more than you expect. Covers public behaviour, transport laws, ID requirements, and civil obligations.",
